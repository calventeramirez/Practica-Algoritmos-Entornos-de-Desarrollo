...
class testMisArray {
	...
	@Test
	void testMaximo() {
		assertEquals(10, MisArrays.maximo(array1));
		assertEquals(9, MisArrays.maximo(array2));
		assertEquals(10, MisArrays.maximo(array3));
	}

	@Test
	void testMinimo() {
		assertEquals(2, MisArrays.minimo(array1));
		assertEquals(1, MisArrays.minimo(array2));
		assertEquals(5, MisArrays.minimo(array3));
	}
}
